...
<Steps>
1. Open Telescope with fuzzy finding: `<leader>fw`
...
4. Type the following command: `:cfdo %s/search/replace/g`
5. Write all changes: `:wa`
</Steps>
...
The prompt will look something like this when all done: `:'<,'>s/^/#/g`

## Format to certain column width

<Steps>
1. Set text width to desired width: `:set textwidth=80`
2. Move to start of file: `gg`
3. Format text from start to the end: `gqG`
</Steps>
